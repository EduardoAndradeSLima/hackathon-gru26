const statusMap = {
  ...
  critico: 'bg-slate-950 text-white border-slate-950',
  critica: 'bg-slate-950 text-white border-slate-950',
  ...
  grau_1: 'bg-emerald-50 text-emerald-700 border-emerald-200',
  grau_2: 'bg-amber-50 text-amber-700 border-amber-200',
  grau_3: 'bg-red-50 text-red-700 border-red-200',
