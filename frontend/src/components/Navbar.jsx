...
export default function Navbar({ onMenu }) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-guarulhos-600 bg-guarulhos-500">
      <div className="flex min-h-16 items-center justify-between gap-3 px-4 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold uppercase text-guarulhos-900">FacilitaGRU</p>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden items-center gap-2 rounded-card border border-guarulhos-600 bg-white/70 px-3 py-2 sm:flex">
