...
values
  ...
  ('Equipe Central de Vagas', 'central@guarulhos.sp.gov.br', crypt('Admin@123', gen_salt('bf')), 'GESTOR_CENTRAL', 'Central de Vagas'),
...
values
  ('Joao Silva', '123.456.789-00', '12345678901', '1951-09-14', 'Rua das Palmeiras, 70', '(11) 99999-1000', 'Vila Galvao', 'Norte', 'Pessoa idosa com renda baixa e dependencia moderada.', '["pessoa_idosa", "deficiencia"]'::jsonb, 'medio', 'aguardando_vaga', 'CREAS Centro', '["Atendimento inicial registrado."]'::jsonb),
  ('Maria Oliveira', '987.654.321-00', '98765432109', '1988-03-18', 'Endereco protegido', '(11) 98888-1000', 'Sigiloso', 'Municipal', 'Mulher em situacao de risco por violencia domestica.', '["violencia_domestica", "risco_social"]'::jsonb, 'alto', 'encaminhado', 'CREAS Centro', '["Encaminhamento de urgencia em avaliacao."]'::jsonb)
on conflict (cpf) do update set status_atendimento = excluded.status_atendimento, grau_risco = excluded.grau_risco;
